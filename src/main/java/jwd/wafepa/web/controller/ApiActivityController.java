...
public class ApiActivityController {
	...
	ResponseEntity<List<ActivityDTO>> getActivities(
		...
		if (name != null) {
			activities = activityService.findByNameContaining(name, page);
		} else {
		...
		return new ResponseEntity<>(toDTO.convert(activities.getContent()), headers, HttpStatus.OK); //getContent iz page objekta da bi dobili podatke
	}
	...
	public ResponseEntity<ActivityDTO> edit(@RequestBody ActivityDTO activity,
		...
		if (activity.equals(null) || activity == null || activity.getName().isEmpty()) {
